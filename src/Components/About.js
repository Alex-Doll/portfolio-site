    ...
    return (
      <div className='about-custom'>
        <div className='container text-left'>
          <p className='about-important'>Hello there!</p>
          <p>If you're reading this then you probably are wanting to get to know a little bit more about me. If that's not why you're on this page
          ...
          <p className='about-important'>- Alex</p>
        </div>
      </div>
    );
  }
